...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> implements Filterable {
    ...
    private List<TaskEntry> mTaskEntriesSearch;
    ...
    */
    ...
    public void setTasks(List<TaskEntry> taskEntries) {
        ...
        mTaskEntriesSearch = new ArrayList<>();
        mTaskEntriesSearch.addAll(mTaskEntries);
    ...
    private Filter filter_Data= new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll( mTaskEntriesSearch );
            }else {
                String filter = constraint.toString().toLowerCase().trim();
                for (TaskEntry dataItem:mTaskEntriesSearch){
